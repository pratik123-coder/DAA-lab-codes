#include <stdio.h>
#include <stdlib.h>
void dectoBin(int decimalNum, FILE *destFile)
{
    if (decimalNum > 0)
    {
        dectoBin(decimalNum / 2, destFile);
...
int main(int argc, char *argv[])
{
    ...
    fprintf(destFile, "Contents of the output file \n");
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        {
            fprintf(destFile, "The binary of %d is ", decimalNum);
            dectoBin(decimalNum, destFile);
            fprintf(destFile, "\n");
        }
        else
        {
